<template>
  <div id="icon-wrapper">
    <div id="logo-container" class="circle-container centered">
      <img id="logo-picture" src="@/assets/logo_g.svg" />
    </div>

    <div
      @mouseover="hoverBack = true"
      @mouseleave="hoverBack = false"
      :class="{ hovering_bg: hoverBack }"
      class="circle-container centered"
      id="back-container"
      @click="close"
    >
      <img id="back-picture" src="@/assets/left-arrow.svg" />
    </div>
  </div>
</template>
